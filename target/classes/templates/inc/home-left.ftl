    ...
    <div id="home-navbar" class="collapse navbar-collapse">
        <ul class="list-group user-nav first">
            <li class="list-group-item">
                <a href="/home"><i class="fa fa-feed"></i> 动态</a>
            </li>
            <li class="list-group-item">
                <a href="/home?method=posts"><i class="fa fa-file-text-o"></i> 我的文章</a>
            </li>
            <li class="list-group-item">
                <a href="/home?method=comments"><i class="fa fa-comment-o"></i> 我的评论</a>
            </li>
        </ul>
        ...
        <ul class="list-group user-nav">
            <li class="list-group-item">
                <a href="/home/notifies">
                    <i class="fa fa-bell-o"></i> 通知 <span class="label label-danger">1</span>
                </a>
            </li>
        </ul>
    </div>
